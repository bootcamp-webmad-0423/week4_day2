...
app.get('/jugadores', (req, res) => {
    ...
    const players = [
        ...
        },
        {
            ...
            lastName: "James",
            team: "CLE",
            photo: "https://estaticos-cdn.sport.es/clip/db57f5e5-7f86-47a4-824d-a11acadf3aed_media-libre-aspect-ratio_default_0.jpg",
        },
        {
            name: "Emanuel",
            lastName: "Ginóbilli",
...
app.listen(5005, (req, res) => console.log('servidor levantado'))